        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/sermas" end className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <LayoutDashboard className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Resumen 30d</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/sermas/medios" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <Newspaper className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Medios</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/sermas/instagram" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <SiInstagram className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Instagram</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/sermas/twitter" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <FaXTwitter className="mr-2 h-4 w-4" />
                    {!collapsed && <span>X (Twitter)</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/sermas/tiktok" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <SiTiktok className="mr-2 h-4 w-4" />
                    {!collapsed && <span>TikTok</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/sermas/facebook" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <SiFacebook className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Facebook</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/sermas/linkedin" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <FaLinkedin className="mr-2 h-4 w-4" />
                    {!collapsed && <span>LinkedIn</span>}
                  </NavLink>
                </SidebarMenuButton>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut" end className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <LayoutDashboard className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Resumen 30d</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut/medios" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <Newspaper className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Medios</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut/instagram" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <SiInstagram className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Instagram</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut/twitter" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <FaXTwitter className="mr-2 h-4 w-4" />
                    {!collapsed && <span>X (Twitter)</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut/tiktok" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <SiTiktok className="mr-2 h-4 w-4" />
                    {!collapsed && <span>TikTok</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut/facebook" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <SiFacebook className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Facebook</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut/linkedin" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <FaLinkedin className="mr-2 h-4 w-4" />
                    {!collapsed && <span>LinkedIn</span>}
                  </NavLink>
                </SidebarMenuButton>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <NavLink to="/dashboard/catsalut/mybusiness" className="hover:bg-sidebar-accent/50" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium">
                    <SiGoogle className="mr-2 h-4 w-4" />
                    {!collapsed && <span>Reseñas Google</span>}
                  </NavLink>
                </SidebarMenuButton>
